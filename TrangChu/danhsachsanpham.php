...
if (isset($_GET['category_id']) && isset($_GET['brand_id'])) {
    ...
    $listsanpham = $sanphamdb->getsanphambyloaivahang($categoryID, $brandID);
...
foreach ($listsanpham as $sanpham) {
    ...
    echo '            <a class="add_to_cart_button" " rel="nofollow" href="addtocart.php?spid='.$sanpham->getidsanpham().'">Thêm Vào Giỏ Hàng</a>';
    echo '        </div>';
    echo '    </div>';
    echo '</div>';
}
...
echo '</div>';
   ...
   echo  '</div>';
    ...
    echo "Vui lòng chọn một loại sản phẩm và hãng điện thoại cụ thể.";
}
?>
