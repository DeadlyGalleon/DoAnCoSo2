        ...
        <div class="row">
            <nav>
                ...
                <ul class="nav navbar-nav">
                    <li><a href="shop.php">Trang Chủ</a></li>
                    <?php
                    ...
                    echo '<li><a href="danhsachsanpham1.php?category_id=' . 1 . '">Tất Cả</a>';
                        
                        
                        echo '</li>'; 
                    foreach ($listhang as $hang) {
                        echo '<li><a href="danhsachsanpham.php?category_id=' . 1 . '&brand_id=' . $hang->getidhang() . '">' . $hang->gettenhang() . '</a>';
                    ...
                    echo '<li class="dropdown">';
                    echo '<a class="dropdown-toggle" data-toggle="dropdown" href="danhsachsanpham3.php?category_id=phukien">' . 'Phụ Kiện' . '</a>';
                    echo '<ul class="dropdown-menu">';
                    echo '<li><a href="danhsachsanpham3.php?category_id=phukien">Tất Cả</a></li>';
                    ...
                    foreach ($listphukien as $phukien) {
                        echo '<li><a href="danhsachsanpham1.php?category_id=' . $phukien->getidloai() . '">' . $phukien->gettenloai() . '</a>';
...
foreach ($listhang as $hang){
    ...
    echo '<li><a href="danhsachsanpham.php?category_id=' . $phukien->getidloai() . '&brand_id=' . $hang->getidhang() . '">' . $hang->gettenhang() . '</a>';
}
                    ...
                    echo '<li class="dropdown">';
                    echo '<a class="dropdown-toggle" data-toggle="dropdown" href="shop.php">' . 'Hãng' . '</a>';
                    echo '<ul class="dropdown-menu">';
                    ...
                    foreach ($listhang as $hang) {
                        echo '<li><a href="danhsachsanpham2.php?brands=' . $hang->getidhang() . '">' . $hang->gettenhang() . '</a>';
